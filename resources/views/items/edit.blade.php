            ...
            @endcan
                ...
                <div class="form-group">
                    ...
                    <select id="condition" name="condition" class="form-control @error('condition') is-invalid @enderror">
                        ...
                        <option value="good" {{ old('condition', $item[0]->condition) == 'good' ? 'selected' : '' }}>Baik</option>
                        <option value="fair" {{ old('condition', $item[0]->condition) == 'fair' ? 'selected' : '' }}>Sedang</option>
                        <option value="bad" {{ old('condition', $item[0]->condition) == 'bad' ? 'selected' : '' }}>Rusak</option>
                    </select>
                    @error('condition')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
