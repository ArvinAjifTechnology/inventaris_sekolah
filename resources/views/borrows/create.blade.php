        ...
        <div class="col-lg-6">
            <form method="POST" action="{{ route('borrows.store') }}" class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="borrow_quantity" name="borrow_quantity" class="form-control @error('borrow_quantity') is-invalid @enderror" value="{{ old('borrow_quantity') }}" required>
